...
struct StoryBrain {
    ...
    mutating func goToDestinationStory(choiceTitle: String) {
        currentStoryNumber = stories[currentStoryNumber].choice1 == choiceTitle ? stories[currentStoryNumber].choice1Destination : stories[currentStoryNumber].choice2Destination
